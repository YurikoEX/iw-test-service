...
class Worker implements IWorker {
    ...
    constructor(dependencyNames: string[], comm: IComm, service: IAm, whoAmI: IAm, opts?: IWorkerOpts) {
        ...
        this.dependencies = new Collection<IDependency<IWorkerChild>>(idHelper.newId());
    ...
    protected getCommEmit(event: ICommEmit|string, method?: string): ICommEmit {
        ...
        evt.id = _.isUndefined(evt.id) ? idHelper.newId() : evt.id;
        evt.emitter = _.isUndefined(evt.emitter) ? this.me : evt.emitter;
        return evt;
    }
